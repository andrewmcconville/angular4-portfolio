        ...
        sections: [
            {
                ...
                content: [
                    "Stack Overflow’s greatest strength is offering free access to questions and answers from the world’s greatest technical talent, which has led Stack Overflow to opportunities in developer marketing, technical recruiting, market research, and enterprise knowledge sharing.",
            ...
            },
            {
                ...
                content: [
                    "After researching the business side of Stack Overflow, it was time to take a deep dive into Stack Overflow's users. To my surprise the interview process was the easy part, however coming up with great questions proved difficult and I found myself reworking my questions after each interview.",
                    "Gaining access to user data was quite easy given the nature of Stack Overflow's open source user data. Stack Overflow also conducts user surveys in which thousands of developers participate."
                ],
                media: {
                    src: "2017/12/stack-overflow-user-research-interviews.jpg",
                    caption: "Brief overview of data collected from user interviews alongside statistics from Stack Overflow's Developer Survey.",
                    height: 386,
                    shadow: true
                }
            },
            {
                name: "Task Analysis",
                content: [
                    "When interacting with users, the task analysis offered the most revealing insights into both the product and the user. Watching a person's interactions with a product, device, or object–especially without distracting them–allowed for an honest collection of data. What a person says during an interview or survey and how they actually use a product can be substantially different."
                ],
                media: {
            ...
            },
            {
                name: "Personas",
                content: [
                    "After just a few interviews three distinct personas began to form. The first persona is the user who lurks on Stack Overflow, using it to look up answers to questions past users have posted; this is a majority of users to the site. Then, there is the user who dabbles in posting both questions and answers, usually in their down time at work or school but does not often make a habit of it. Finally, the rockstar persona rarely asks questions but spends a large amount of time answering as many questions as they can in order to collect as many reputation points as possible."
                ],
                media: {
            ...
            },
            {
                ...
                content: [
                    "As much as programmers love Stack Overflow, most users never actively participate in the Stack Overflow community. For them, Stack Overflow is a bank of answers to their programming questions. Of the 8 million registered users, only 23.1% have asked more than one question and only 1.6% have asked more than five questions.",
                    "But why?",
            ...
            },
            {
                name: "The Happy Path",
                content: [
                    "The happy-path assumes technology can solve all our design and user experience goals and where technology fails we can use magic. This freedom lets us take our design from start to finish without messy implementation details.",
                    "It's important to keep in mind users engage with Stack Overflow in different ways, to different degrees and with different product offerings. The goal, then, of this project going forward would be to make the process of asking a question on Stack Overflow easier, more transparent, and less intimidating."
                ]
            },
            {
                name: "Journey Map",
                content: [
                    "I constructed a journey map for my lurker persona, Amy, which represents every interaction she has leading up to, during, and after posting a question on Stack Overflow. Mapping her experiences and pain points along with areas for improvement at such high detail allows for visibility into the moments where she might abandon her task. This opens the possibility of addressing each issue independently of the others while maintaining context within her overall goal."
                ],
                media: {
            ...
            },
            {
                name: "Scenarios",
                content: [
                    "In preparing for ideation, sketching, wireframing, and prototyping, I brainstormed a few happy-path user scenarios around the pain points discovered during user research. These are prompting existing Stack Overflow users to post a question upon successive page loads of similar posts and creating a different question posting process for those asking a question for the first time."
                ],
                media: {
            ...
            },
            {
                name: "Next Steps",
                content: [
                    "Stack Overflow's questions and answers are major drivers of traffic to the site, and user interviews have shown that Q&A is by far the leading feature users interact with on Stack Overflow. Without new questions, traffic will stagnate. As new programming languages and techniques are introduced, developers will continue to need help learning them. Getting substantive, helpful content on Stack Overflow begins with users posting new questions.",
                    "Up next for the project will be ideation, sketching, and prototyping a solution which encourages new users to post questions on Stack Overflow.",
                    "The full report summarizing my research can be downloaded as a PDF by following the link below."
                ]
            }
        ]
    },
